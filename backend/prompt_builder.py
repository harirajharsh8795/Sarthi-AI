        ...
        if has_user_doc:
            if is_medical_context:
                doc_directive = (
                    ...
                    "   - Check if an explicit disease diagnosis is written in Context Information.\n"
                    ...
                    "   - CRITICAL BAN: NEVER mention or invent unrelated diseases or test names unless written in Context Information!\n"
                    ...
                    "   ### 🔬 Test Results\n"
                    "   - List ONLY the exact test names and result values written in Context Information. Do NOT invent or add any unlisted tests.\n"
                    "   ### 💡 Summary\n"
