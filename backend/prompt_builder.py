    ...
    def build_adaptive_prompt(
        ...
        if has_user_doc:
            doc_directive = (
                ...
                "   ### 🔬 Test Results\n"
                "   - List ALL test names and exact result values found in Context Information (e.g. for Serology: HBS AG SPOT: NON REACTIVE, HIV SPOT: NON REACTIVE, HCV SPOT: NON REACTIVE). DO NOT output test names or numbers like Cholesterol unless written in Context Information.\n"
                "   ### 💡 Summary\n"
